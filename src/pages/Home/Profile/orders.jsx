          ...
          <ProfileSidebar>
            <div className="flex flex-col sm:flex-row justify-between">
              ...
              <div className="flex bg-slate1 rounded-full p-1.5 space-x-1.5 mb-5">
                <button
                  className={`px-4 sm:px-6 py-1 sm:py-2 text-black rounded-full hover:bg-slate1 transition-all duration-300 text-sm md:text-base font-tbLex ${
                    activeTab === "services"
                ...
                {activeTab === "services" && (
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:leading-[1.8] ">
                    {services.map((s) => (
                      <div
                        key={s.id}
                        className="bg-[#9E52D8] rounded-lg p-4 text-white cursor-pointer hover:bg-[#8A47C4] transition-colors"
