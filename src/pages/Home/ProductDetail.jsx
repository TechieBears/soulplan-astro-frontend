              ...
              <div className="md:hidden flex space-x-2 mt-4 overflow-x-auto pb-2">
                {product?.images?.map((img, index) => (
                  <button
                    key={index}
                    onClick={() => setCurrentImageIndex(index)}
                    className={`relative w-16 h-16 aspect-square rounded overflow-hidden border-2 flex-shrink-0 ${
                      currentImageIndex === index
                        ? "border-orange-500"
                        : "border-transparent "
                    }`}
            ...
            <div className="border-b border-slate-200/60">
              <nav className="flex sm:space-x-4 lg:space-x-8">
                <button
                  ...
                  className={`relative py-3 px-1 text-sm lg:text-base font-medium transition-colors ${
