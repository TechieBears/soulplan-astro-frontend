            ...
            <div className="bg-white rounded-xl m-4 sm:m-5 shadow-sm  p-5 sm:p-7 ">
                <div className="flex justify-between flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 mb-6">
                    <div className="lg:space-y-[1px]">
                        <h2 className='font-tbPop text-base md:text-lg lg:text-xl font-semibold text-black'>All Refer & Earn</h2>
                        <h6 className='text-slate-500 font-tbLex font-normal text-xs lg:text-sm'>Recently added refer & earn will appear here</h6>
                    </div>
                </div>
