            ...
            {loading ? (
              ...
              >
                {testimonials?.map((t, index) => (
                  ...
                  >
                    <div
                      className={`w-full border-2  bg-white rounded-xl shadow-lg transition-all duration-300 overflow-hidden flex flex-col justify-between ${
                        activeIndex === index
                          ? " " // Orange border for middle card
                          : "hover:shadow-xl"
                      }`}
                    >
                      {/* Card Header */}
                      <div className="p-4 border-b border-gray-100">
                        <div className="flex items-center space-x-3 my-2">
                          <img
                            ...
                            alt={`${
                              t?.user?.firstName || t?.user_id?.name || "User"
                            }'s testimonial`}
