...
const AvailableCouponsModal = ({ isOpen, onClose, type }) => {
  ...
  return (
    <div className="fixed inset-0 z-[999999] overflow-y-auto animate-fadeIn">
      <div className="fixed inset-0 backdrop-blur-[2.3px] bg-black/20 animate-fadeIn" onClick={onClose} />
      
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative w-full max-w-xl bg-white rounded-lg shadow-xl animate-scaleIn">
          {/* Header */}
          <div className="flex items-center justify-between border-b bg-slate1 rounded-t-lg sticky top-0 z-10 p-4 sm:px-6">
            <div>
          ...
          {/* Footer */}
          <footer className="py-3 flex flex-col sm:flex-row bg-slate1 rounded-b-lg justify-between px-4 space-y-3 sm:space-y-0 sm:space-x-3 w-full items-center text-center sm:text-left">
