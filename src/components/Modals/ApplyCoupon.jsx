            ...
            <Dialog as="div" className="relative z-[999999]" onClose={onClose}>
                ...
                <div className="fixed inset-0 z-[9999999] w-screen overflow-y-auto">
                    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        ...
                        >
                            <Dialog.Panel className="relative transform overflow-hidden rounded-xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl max-h-[85vh] overflow-y-auto">
                                {/* Header */}
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-4 max-h-[400px] overflow-y-auto">
                                                {couponsData.map((coupon) => (
                                                    <div
                                                        key={coupon.id}
                                                        className={`flex items-start gap-4 p-4 cursor-pointer transition-all rounded-lg border ${selectedCoupon === coupon.id
                                                    ...
                                                    >
                                                        ...
                                                        <div className="flex-1">
                                                            <div className="flex items-center gap-2 mb-2">
                                                                <span
                                                                    className={`px-3 py-1 border rounded-md text-sm font-semibold font-tbPop ${selectedCoupon === coupon.id
                                    ...
                                    <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
                                        ...
                                        <div className="flex items-center gap-3 w-full lg:w-auto">
                                            ...
                                            <button
                                                ...
                                                className={`flex-1 lg:flex-none px-6 py-3 rounded-lg text-white text-base transition-colors font-tbPop ${selectedCoupon
