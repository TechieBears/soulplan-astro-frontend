...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-3xl mt-12 mx-auto px-6 py-8">
      <h1 className="text-3xl font-semibold text-center text-gray-800 mb-6">Privacy Policy</h1>

      <p className="text-lg text-gray-700 mb-6">
        At [Your Company Name], we take your privacy seriously. This Privacy Policy outlines
        the types of personal information we collect and how we use, store, and protect it.
      </p>
      ...
      <ul className="list-disc pl-6 space-y-2 text-gray-700">
        ...
        <li><strong>Usage Data:</strong> Information on how you interact with our services, including pages visited, time spent on each page, etc.</li>
        <li><strong>Cookies:</strong> We may use cookies to improve your experience on our website.</li>
      </ul>
      ...
      <p className="text-lg text-gray-700 mb-4">
        We implement security measures to protect your personal information. However, no method of transmission over the internet is 100% secure, so we cannot guarantee absolute security.
      </p>

      <h2 className="text-2xl font-semibold text-gray-800 mt-6 mb-4">4. Sharing Your Information</h2>
      <p className="text-lg text-gray-700 mb-4">
        We do not sell, trade, or rent your personal information to third parties. However, we may share it in the following cases:
      </p>
      <ul className="list-disc pl-6 space-y-2 text-gray-700">
      ...
      <p className="text-lg text-gray-700 mb-4">
        Depending on your jurisdiction, you may have the right to access, correct, or delete your personal information. You can also withdraw your consent for processing at any time.
      </p>
