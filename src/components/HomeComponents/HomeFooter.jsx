  ...
  return (
    ...
    >
      ...
      <div className="relative container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-lg">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="text-xl font-bold">SOULPLANE</h2>
        ...
        {/* ===== Bottom Bar ===== */}
        <div className="flex flex-col md:flex-row justify-between items-center mt-6 text-sm border-t border-white/20 pt-4">
