...
const SidebarLink = ({ item, isActiveLink, index }) => {
    ...
    return (<>
        {subMenu ?
            ...
            </NavLink > : <NavLink to={link} i={index} className={`${!isActiveLink ? "px-5" : "justify-center"} flex items-center  space-x-2  group pt-2 pb-1 my-1 w-full origin-left relative transition-all duration-500`}>
