                  ...
                  {navItems.map((item, index) => (
                    <React.Fragment key={index}>
                      {item.path.startsWith("/") ? (
                        <Link
                          to={item.path}
                          className={`flex items-center justify-between font-normal font-tbPop transition-all duration-300 ${
                            isActive(item.path)
                        ...
                        <button
                          className={`flex items-center justify-between px-3 py-[18px] rounded-lg font-medium transition ${
                            isActive(item.path)
